...
function set_pg_content(pg_id) {
	...
	switch (pg_id) {
		...
		break;
		case 3:
		content = '<link rel="stylesheet" type="text/css" href="slide3/slide1.css" media="screen"/><div class="s1_1"><img src="slide3/s1_1.png" width="100%" height="100%" alt=""/></div><div class="s1_2"><img src="slide3/s1_2.png"/></div><div class="s1_3"><img src="slide3/s1_3.png"/></div><div class="s1_4"><img src="slide3/s1_4.png"/></div><div class="s1_5"><img src="slide3/s1_5.png"/></div><div class="s1_6"><img src="slide3/s1_6.png"/></div><div class="s1_7"><img src="slide3/s1_7.png"/></div><div class="s1_8"><img src="slide3/s1_8.png"/></div>';
		break;
		case 4:
		content = '<link rel="stylesheet" type="text/css" href="slide4/slide1.css" media="screen"/><div class="s1_1"><img src="slide4/s1_1.png" width="100%" height="100%" alt=""/></div><div class="s1_2"><img src="slide4/s1_2.png"/></div>';
		break;
	}
